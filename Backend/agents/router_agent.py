...
from tools.updating_ticket import update_ticket
...
def router_agent_prompt(state: AgentState):
...
async def router_agent_function(query: str, user_id: str, thread_id: str, query_id: str, timeout_: int = 55):
    try:
